    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'string',
                'max:255',
                TRule::unique('parties')->ignore($ignore),
            ],
            'phone' => ['nullable', 'string', 'max:255', TRule::unique('parties')->ignore($ignore)],
            'email' => ['nullable', 'email', TRule::unique('parties')->ignore($ignore)],
            'pan' => ['nullable', 'string', new NepaliPan, TRule::unique('parties')->ignore($ignore)],
