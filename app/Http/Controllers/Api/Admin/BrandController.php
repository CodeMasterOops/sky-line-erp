...
class BrandController extends Controller
{
    ...
    /**
     * @Permissions("update_brand_status", group="brand", desc="Update Status")
     */
    ...
    /**
     * @Permissions("update_brand_featured_status", group="brand", desc="Update Featured Status")
     */
    public function updateFeaturedStatus(Brand $brand)
    {
        $brand->update([
