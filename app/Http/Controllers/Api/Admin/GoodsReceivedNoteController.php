...
class GoodsReceivedNoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return response()->json([
            'data' => $grn->load(['grnItems.productVariant.product', 'party', 'warehouse']),
    ...
    public function update(Request $request, GoodsReceivedNote $goodsReceivedNote)
    {
        ...
        return response()->json([
            'data' => $goodsReceivedNote->fresh()->load(['grnItems.productVariant.product', 'party', 'warehouse']),
