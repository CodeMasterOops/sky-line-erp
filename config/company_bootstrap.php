...
return [
    ...
    'account_setting_codes' => [
        ...
        'supplier_advance_account_id' => 'SUPPADV',
        'suspense_account_id' => 'SUSP',
        'writeoff_account_id' => 'WROFF',
        'rounding_account_id' => 'ROUND',
        'bad_debt_account_id' => 'BDE',
        'stock_adjustment_account_id' => 'SADJ',
        'wip_account_id' => 'WIP',
        'manufacturing_variance_account_id' => 'MVAR',
        'damage_account_id' => 'DMG',
        'pos_cash_account_id' => 'POSC',
        'pos_float_account_id' => 'POSF',
        'pos_over_short_account_id' => 'POSOS',
    ],
    'default_branch' => [
        'name' => 'Main',
        'code' => 'MAIN',
