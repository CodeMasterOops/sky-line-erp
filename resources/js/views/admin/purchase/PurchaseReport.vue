            ...
            <div class="card border border-success sale-widget flex-fill">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div class="ms-2">
                        ...
                        <h3 v-if="!loading">{{ fmt(summary.total_purchase) }}</h3>
                ...
                <table class="table datatable">
                    ...
                    <tfoot>
                        <tr class="fw-bold bg-light">
                            ...
                            <td>{{ reportRows.reduce((s, r) => s + Number(r.purchased_qty), 0) }}</td>
                            <td>{{ fmt(summary.total_purchase) }}</td>
                            <td></td>
                        </tr>
                    </tfoot>
                </table>
...
async function loadParties() {
    ...
    try {
        const res = await apiAdmin('party', 'get', {type: 'supplier', per_page: 500});
...
async function loadReport() {
    ...
    try {
        ...
        const res = await apiAdmin('purchase-report', 'get', params);
