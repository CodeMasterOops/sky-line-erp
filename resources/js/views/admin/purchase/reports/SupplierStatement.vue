<template>
    <PageHeader hide-action-buttons title="Supplier Statement" subtitle="Formal account statement for a supplier" />
    ...
    <section class="section">
        ...
        <div v-else-if="!loading" class="card border-0 shadow-sm">
            <div class="card-body text-center text-muted py-5 no-print">
                ...
                Select a supplier and click 'Generate' to produce the statement.
            </div>
        </div>
    </section>
</template>
