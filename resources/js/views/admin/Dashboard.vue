      ...
      <div class="card revenue-widget flex-fill">
        <div class="card-body">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <router-link to="/reports/profit-and-loss" class="text-decoration-underline fs-13 fw-medium">View
              All</router-link>
          </div>
        </div>
      </div>
      ...
      <div class="card revenue-widget flex-fill">
        <div class="card-body">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <router-link to="/reports/invoice-report" class="text-decoration-underline fs-13 fw-medium">View
              All</router-link>
          </div>
        </div>
      </div>
      ...
      <div class="card revenue-widget flex-fill">
        <div class="card-body">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <router-link to="/expenses/expenses-list" class="text-decoration-underline fs-13 fw-medium">View
              All</router-link>
          </div>
        </div>
      </div>
      ...
      <div class="card revenue-widget flex-fill">
        <div class="card-body">
          ...
          <div class="d-flex align-items-center justify-content-between">
            ...
            <router-link to="/sales-report/sales-report" class="text-decoration-underline fs-13 fw-medium">View
              All</router-link>
          </div>
        </div>
      </div>
        ...
        <div class="card-body pb-0">
          <div>
            ...
            <div id="sales-daychart">
              <apexchart type="bar" height="245" :options="salesDaychart.sline" :series="salesDaychart.series">
              </apexchart>
            </div>
          </div>
        </div>
        ...
        <div class="card-footer pb-sm-0">
          <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <div class="dropdown dropdown-wraper">
              <a href="javascript:void(0);" class="dropdown-toggle btn btn-sm" data-bs-toggle="dropdown"
                aria-expanded="false">
          ...
          <div class="row align-items-center">
            <div class="col-sm-5">
              <div id="customer-chart">
                <apexchart type="radialBar" height="130" :options="customerChart.chart" :series="customerChart.series">
                </apexchart>
              </div>
            </div>
            <div class="col-sm-7">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body sell-product">
          <div class="d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img src="@/assets/images/products/product-01.jpg" alt="img">
              </a>
              <div class="ms-2">
          ...
          <div class="d-flex align-items-center justify-content-between border-bottom">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img src="@/assets/images/products/product-02.jpg" alt="img">
              </a>
              <div class="ms-2">
    ...
    <div class="col-xxl-4 col-md-6 d-flex">
      <div class="card flex-fill">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
          ...
          <router-link to="/inventory/low-stocks" class="fs-13 fw-medium text-decoration-underline">View
            All</router-link>
        </div>
        <div class="card-body">
      ...
      <div class="card flex-fill">
        ...
        <div class="card-body pb-0">
          ...
          <div id="sales-statistics">
            <apexchart type="bar" height="290" :options="salesStatistics.sline" :series="salesStatistics.series">
            </apexchart>
          </div>
        </div>
      </div>
    ...
    <div class="col-xl-6 col-sm-12 col-12 d-flex">
      <div class="card flex-fill">
        <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-3">
          ...
          <router-link to="/sales/online-orders" class="fs-13 fw-medium text-decoration-underline">View
            All</router-link>
        </div>
                  ...
                  <tbody>
                      ...
                      <td>
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img src="@/assets/images/profiles/avatar-01.jpg" class="img-fluid" alt="img">
                          </a>
                          <div class="ms-2">
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="d-flex align-items-center file-name-icon">
                          <a href="javascript:void(0);" class="avatar avatar-md">
                            <img src="@/assets/images/profiles/avatar-10.jpg" class="img-fluid" alt="img">
                          </a>
                          <div class="ms-2">
  ...
  <div class="row">
    ...
    <div class="col-xxl-4 col-md-6 d-flex">
      <div class="card flex-fill">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-3">
          ...
          <router-link to="/ecommerce/customers" class="fs-13 fw-medium text-decoration-underline">View
            All</router-link>
        </div>
        <div class="card-body">
          <div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3">
            <div class="d-flex align-items-center">
              <a href="javascript:void(0);" class="avatar avatar-lg">
                <img src="@/assets/images/profiles/avatar-01.jpg" alt="img" />
              </a>
              <div class="ms-2">
    ...
    <div class="col-xxl-4 col-md-12 d-flex">
      <div class="card flex-fill">
        ...
        <div class="card-body pb-0">
          <div id="heat_chart">
            <apexchart type="heatmap" height="340" :options="heatChart.sline" :series="heatChart.series"></apexchart>
          </div>
        </div>
      </div>
    </div>
