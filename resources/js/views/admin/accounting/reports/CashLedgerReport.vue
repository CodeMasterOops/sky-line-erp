<template>
    <PageHeader title="Cash Ledger" subtitle="Ledger for cash accounts" @refresh="generateReport"/>
    ...
    <section class="section">
                ...
                <table class="table align-middle mb-0">
                    ...
                    <tr v-else>
                        <td colspan="6" class="text-center py-5 text-muted">
                            Select a cash account to view ledger entries.
                        </td>
                    </tr>
                    </tbody>
        ...
        <div v-else class="text-center text-muted py-5 no-print">
            ...
            Select a cash account and click 'Generate' to load the ledger.
        </div>
    </section>
</template>
...
const cashAccounts = computed(() =>
    (accounts.value?.data || []).filter((a) => a.label?.toLowerCase().includes('cash'))
);
