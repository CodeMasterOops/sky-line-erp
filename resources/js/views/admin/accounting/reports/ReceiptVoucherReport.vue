<template>
    <PageHeader title="Receipt Voucher Report" subtitle="Accounting report" @refresh="generateReport"/>
    ...
    <section class="section">
        ...
        <ReportPrintShell
            v-if="dataLoaded"
            report-title="Receipt Voucher Report"
        ...
        >
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <template v-else-if="journalRows.length">
                        <template v-for="row in journalRows" :key="row.id">
                            ...
                            >
                                ...
                                <td v-if="itemIndex === 0" :rowspan="row.items.length">{{ adToBsDate(row.date) }}</td>
                                <td v-if="itemIndex === 0" :rowspan="row.items.length">{{ row.voucher_no }}</td>
                    ...
                    <tr v-else>
                        <td colspan="6" class="text-center py-5 text-muted">No receipt vouchers found for the selected period.</td>
                    </tr>
                    </tbody>
