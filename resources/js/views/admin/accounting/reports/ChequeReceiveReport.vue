<template>
    <PageHeader hide-action-buttons title="Cheque Receive Report" subtitle="Cheques received from customers" />
                        ...
                        <tbody>
                            ...
                            <tr v-else-if="!rows.length">
                                <td colspan="9" class="text-center text-muted py-5">
                                    ...
                                    Select a date range and click 'Generate' to view received cheques.
                                </td>
                            </tr>
...
const exportCsv = () => {
    ...
    a.download = 'cheque-receive-report.csv';
    a.click();
};
