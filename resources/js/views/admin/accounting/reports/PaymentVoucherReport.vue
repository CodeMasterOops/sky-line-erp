<template>
    <PageHeader title="Payment Voucher Report" subtitle="Accounting report" @refresh="generateReport"/>
    ...
    <section class="section">
        ...
        <ReportPrintShell
            v-if="dataLoaded"
            report-title="Payment Voucher Report"
        ...
        >
            <div class="table-responsive">
                <table class="table align-middle mb-0">
                    ...
                    <tr v-else>
                        <td colspan="6" class="text-center py-5 text-muted">No payment vouchers found for the selected period.</td>
                    </tr>
                    </tbody>
