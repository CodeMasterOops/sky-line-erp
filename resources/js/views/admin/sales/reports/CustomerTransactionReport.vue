<template>
    <PageHeader hide-action-buttons title="Customer Transaction Report" subtitle="All transactions for a selected customer" />
                        ...
                        <tbody>
                            <tr v-if="!rows.length && !loading">
                                <td colspan="6" class="text-center text-muted py-5">
                                    {{ filters.party_id ? 'Click Generate to load transactions.' : 'Select a customer to get started.' }}
                                </td>
                            </tr>
                            <tr v-if="loading">
...
const exportCsv = () => {
    ...
    a.download = 'customer-transaction.csv';
    a.click();
};
