<template>
    <PageHeader hide-action-buttons title="Sales Ledger Report" subtitle="Customer account statement showing invoices, receipts, credit notes, and running balance" />
                        ...
                        <tbody>
                            <tr v-if="!rows.length && !loading">
                                <td colspan="6" class="text-center text-muted py-5">
                                    {{ filters.party_id ? 'Click Generate to load ledger.' : 'Select a customer to get started.' }}
                                </td>
                            </tr>
