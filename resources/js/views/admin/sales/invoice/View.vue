<template>
    <PageHeader title="Invoice view" subtitle="Invoice preview (placeholder)" />
    <div class="card">
        <div class="card-body">
            ...
            <div class="row border-bottom mb-3">
                ...
                <div class="col-md-2">
                    <div class="mb-3">
                        ...
                        <div class="mt-3">
                            <img src="@/assets/images/qr.svg" class="img-fluid" alt="QR" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center border-bottom mb-3">
                ...
                <div class="col-md-5">
                    <div class="text-end">
                        <img src="@/assets/images/sign.svg" class="img-fluid" alt="sign" />
                    </div>
                    <div class="text-end mb-3">
    ...
    <div class="d-flex justify-content-center align-items-center mb-4">
        ...
        <a href="#" class="btn btn-secondary d-flex justify-content-center align-items-center border"><i
