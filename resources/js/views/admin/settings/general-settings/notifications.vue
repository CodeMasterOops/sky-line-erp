                  ...
                  <div class="settings-wrapper d-flex">
                        ...
                        <div class="card flex-fill mb-0">
                              <div class="card-header">
                                    <h4 class="fs-18 fw-bold">Notifications</h4>
                              </div>
                              <div class="card-body">
                                    <div>
