<template>
      <div>
            <PageHeader title="General Settings" subtitle="Manage your general settings" />
      </div>
                                    ...
                                    <div>
                                          <div
                                                ...
                                                <a href="javascript:void(0);" class="btn btn-primary"
                                                      data-bs-toggle="modal" data-bs-target="#change-password">Change
                                                      Password</a>
                                          </div>
                                          <div
                                                class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 border-bottom mb-3 pb-3">
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div>
                                                            <h5 class="fs-16 fw-medium mb-1">Two Factor Authentication
                                                            </h5>
                                                            <p class="fs-16">Receive codes via SMS or email every time
                                                                  you login</p>
                                                      </div>
                                                </div>
                                                <div
                                          ...
                                          <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div>
                                                            <h5 class="fs-16 fw-medium mb-1">Phone Number Verification
                                                            </h5>
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <a href="javascript:void(0);" class="btn btn-primary mt-0"
                                                            ...
                                                            data-bs-target="#phone-verification">Change</a>
                                                      <a href="javascript:void(0);"
                                                            class="btn btn-secondary ms-3">Remove</a>
                                                </div>
                                          </div>
                                          <div
                                                class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 border-bottom mb-3 pb-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <a href="javascript:void(0);" class="btn btn-primary mt-0"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#email-verification">Change</a>
                                                      <a href="javascript:void(0);"
                                                            class="btn btn-secondary ms-3">Remove</a>
                                                </div>
                                          </div>
                                          <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div>
                                                            ...
                                                            <p class="fs-16">Manage devices associated with the account
                                                            </p>
                                                      </div>
                                                </div>
                                                <a href="javascript:void(0);" class="btn btn-primary mt-0"
                                          ...
                                          <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div>
                                                            ...
                                                            <p class="fs-16">Manage activities associated with the
                                                                  account</p>
                                                      </div>
                                                </div>
                                                <a href="javascript:void(0);" class="btn btn-primary mt-0"
                                                      data-bs-toggle="modal" data-bs-target="#account-activity">View</a>
                                          </div>
                                          <div
                                                class="d-flex align-items-center justify-content-between flex-wrap row-gap-3 border-bottom mb-3 pb-3">
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div>
                                                            ...
                                                            <p class="fs-16">This will shutdown your account. Your
                                                                  account will be reactive when you sign in again</p>
                                                      </div>
                                                </div>
                                                <a href="javascript:void(0);"
                                                      class="btn btn-primary mt-0">Deactivate</a>
                                          </div>
                                          <div
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div>
                                                            ...
                                                            <p class="fs-16">Your account will be permanently deleted
                                                            </p>
                                                      </div>
                                                </div>
                                                <a href="javascript:void(0);" class="btn btn-danger"
                                                      data-bs-toggle="modal" data-bs-target="#delete-account">Delete</a>
                                          </div>
                                    </div>
                              </div>
                        </div>
