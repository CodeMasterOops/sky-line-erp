            ...
            <div class="col-xl-4 col-md-6 d-flex">
                <div class="card border-0 shadow-sm sale-widget widget-warning flex-fill">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <p class="fw-medium mb-1">Needs Reordering</p>
                ...
                <div class="card border-0 shadow-sm sale-widget widget-info flex-fill">
                    <div class="card-body d-flex align-items-center">
                        <span class="sale-icon bg-info-subtle text-info">
                            <i class="ti ti-chart-bar-off fs-24"></i>
                        </span>
                        <div class="ms-3">
...
const outOfStockCount = computed(() => rows.value.filter(r => r.current_stock <= 0).length);
const lowStockCount = computed(() => rows.value.filter(r => r.current_stock > 0).length);
