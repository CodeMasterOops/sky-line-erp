                ...
                <div class="card border-0 shadow-sm sale-widget widget-info flex-fill">
                    <div class="card-body d-flex align-items-center">
                        <span class="sale-icon bg-info-subtle text-info">
                            <i class="ti ti-arrows-exchange fs-24"></i>
                        </span>
                        <div class="ms-3">
                            <p class="fw-medium mb-1">Total Transfers</p>
                            <h4 class="mb-0">{{ kpi.total_transfers }}</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-md-6 d-flex">
                <div class="card border-0 shadow-sm sale-widget widget-success flex-fill">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <p class="fw-medium mb-1">Total Quantity Transferred</p>
...
const kpi = computed(() => summary.value ?? {total_transfers: 0, total_quantity: 0});
