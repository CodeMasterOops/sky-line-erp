              ...
              <template v-for="(product,index) in products.data" :key="index">
                <tr v-for="(variant,key) in product.variants" :key="variant.id">
                  ...
                  <td style="width: 90px;">
                    ...
                    <router-link
                        v-can="'list_stock_history'"
                        :to="{name:'admin.stock-history',params:{id:variant.id}}"
                        type="button"
                        title="Stock History"
...
import {useStockStore} from "@/stores/admin/stock.js";
import EditStock from "@/views/admin/stock/Edit.vue";
