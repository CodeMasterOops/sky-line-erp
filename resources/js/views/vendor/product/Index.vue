              ...
              <tr v-for="(product,index) in products.data" :key="index"
                ...
                <td>
                  <a href="#" class="d-flex align-items-center gap-2">
                    <img v-if="product.thumbnail_image_url" :src="product.thumbnail_image_url" height="50" width="50"
                         class="border p-1" :alt="product.name">
                ...
                <td style="width: 140px;">
                  <router-link
                      :to="{name:'vendor.product-show',params:{id:product.id}}"
                      type="button"
                      title="Edit"
                      class="btn btn-sm btn-outline-primary">
                    <i class="fa fa-eye"> </i>
                  ...
                  <router-link
                      :to="{name:'vendor.product-edit',params:{id:product.id}}"
                      type="button"
                      title="Edit"
